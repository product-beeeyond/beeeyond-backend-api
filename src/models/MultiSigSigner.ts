...
export interface MultiSigSignerAttributes {
  id: string;
...
type MultiSigSignerCreationAttributes = Optional<
  MultiSigSignerAttributes,
  "id" | "createdAt" | "updatedAt"
>;

class MultiSigSigner
  extends Model<MultiSigSignerAttributes, MultiSigSignerCreationAttributes>
  implements MultiSigSignerAttributes
{
  public id!: string;
